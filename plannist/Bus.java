...
public class Bus implements Cloneable, Comparable<Bus>{
	...
	public Bus(String busId, int capacity, double cost, int direction, String depot, boolean depotStatus,
			Calendar departureTime) {
		super();
		this.busId = busId;
	...
	public Bus(String busId, int capacity, double cost, int direction, boolean depotStatus,
			Calendar departureTime) {
		super();
		this.busId = busId;
		this.capacity = capacity;
...
//		 if((this.reducedCost - ((Route) o).getReducedCost())<0)   
//             return -1;  
//         else if((this.reducedCost - ((Route) o).getReducedCost())>0)  
//             return 1;  
//         else return 0;
//	}
	...
	/**
	 * @return true: feasible trip. False:infeasible trip.
	 */
